...
function createMockPlay(overrides?: Partial<Play>): Play {
  return {
    ...
    result: { type: 'Run', data: { yards_gained: 5, play_duration: 6, fumble: false, return_yards: 0, out_of_bounds: false, touchdown: false, safety: false, two_point_conversion: false } },
    result_computed: { net_yards: 5, play_duration: 6, turnover: false, offense_score: 'None', defense_score: 'None', offense_timeout: false, defense_timeout: false, incomplete: false, out_of_bounds: false, touchback: false, kickoff: false, punt: false, next_play_kickoff: false, next_play_extra_point: false },
    post_play: { type: 'BetweenPlay', data: { duration: 25, offense_timeout: false, defense_timeout: false, up_tempo: false, defense_not_set: false, critical_down: false } },
    post_play_computed: { net_yards: 0, play_duration: 25, turnover: false, offense_score: 'None', defense_score: 'None', offense_timeout: false, defense_timeout: false, incomplete: false, out_of_bounds: false, touchback: false, kickoff: false, punt: false, next_play_kickoff: false, next_play_extra_point: false },
